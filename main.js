...
import links from './links';//list of 5000+ wikiart url's used for style transfer
...
class Main {
  constructor() {
    ...
    console.log("this.modelSelectStyle:"+this.modelSelectStyle);
    ...
    console.log("this.modelSelectTransformer:"+this.modelSelectTransformer);
  ...
  async loadSeparableTransformerModel() {
    ...
    console.log("completing async loadSeparableTransformerModel()");
    return this.separableTransformNet;
  }

  initalizeWebcamVariables() {
    console.log("starting initalizeWebcamVariables()");
    this.camModal = $('#cam-modal');

    this.snapButton = document.getElementById('snap-button');
    console.log("this.snapButton:"+this.snapButton);
    this.webcamVideoElement = document.getElementById('webcam-video');
    console.log("this.webcamVideoElement:"+this.webcamVideoElement);
  ...
  console.log("end initalizeWebcamVariables()");
  }

  openModal(element) {
    this.camModal.modal('show');
    this.snapButton.onclick = () => {
      console.log("this.snapButton.onclick  clicked");
  ...
  initializeStyleTransfer() {
    console.log("start initializeStyleTransfer()");
    // Initialize images
    this.contentImg = document.getElementById('content-img');
    console.log("initializeStyleTransfer() > typeof(this.contentImg):"+typeof(this.contentImg));
    ...
    console.log("this.styleRatioSlider:"+this.styleRatioSlider);
    ...
    console.log("end initializeStyleTransfer()");
  }

  initializeCombineStyles() {
    console.log("start initializeCombineStyles()");
    // Initialize images
    ...
    console.log("end initializeCombineStyles()");
  }
  ...
  setImage(element, selectedValue) {
    console.log("start of setImage(element, selectedValue):selectedValue="+selectedValue);
    ...
    console.log("at end of setImage(element, selectedValue) : typeof(element.src):"+typeof(element.src));
    console.log("at end of setImage(element, selectedValue) : element.src:"+element.src);
  }
  ...
  disableStylizeButtons() {
    console.log("disableStylizeButtons()")
  ...
  async startStyling() {
    console.log("async startStyling() start");
    await tf.nextFrame();
    ...
    console.log("in async startStyling() ... Stylizing image...")
    await tf.nextFrame();
    ...
    stylized.dispose();
    console.log("async startStyling() completed");
  }

  async startCombining() {
    console.log("start async startCombining()");
    await tf.nextFrame();
    ...
    stylized.dispose();
    console.log("end async startCombining()");
  }

  async benchmark() {
    console.log("start async benchmark()");
    ...
    x.dispose();
    bottleneck.dispose();
    console.log("end async benchmark()");
  }

  async benchmarkStyle(x, styleNet) {
    start("start async benchmarkStyle");
    ...
    //console.log(time);
    console.log("end async benchmarkStyle:"+time);
  }
...
window.mobilecheck = function() {
  console.log("start window.mobilecheck = function()");
  var check = false;
